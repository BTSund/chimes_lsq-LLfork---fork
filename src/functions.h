...
public:
				   ...
				   PRINT_ENERGY_STRESS(false)
	{
		...
		ALCH_1B_ORDER = 1; // CHANGE THIS IS SO I CAN START WITHOUT SETTING UP input.C
		ALCH_2B_ORDER = 1; // CHANGE THIS IS SO I CAN START WITHOUT SETTING UP input.C
		ALCH_3B_ORDER = 1; // CHANGE THIS IS SO I CAN START WITHOUT SETTING UP input.C
		ALCH_4B_ORDER = 1; // CHANGE THIS IS SO I CAN START WITHOUT SETTING UP input.C
